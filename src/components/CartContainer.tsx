      ...
      {cart?.length > 0 ? (
            ...
            <div className="w-96 flex flex-col gap-4">
              ...
              <div className="flex justify-end flex-col text-center">
                <button
                  ...
                  className="bg-blue-800 text-white hover:bg-blue-600 hoverEffect px-8 py-3 rounded-lg font-semibold disabled:bg-lightOrange/50 disabled:cursor-not-allowed"
                >
                  Proceed to Checkout
                </button>
                {!session?.user && (
        ...
        >
          ...
          <div className="max-w-[500px] p-4 py-8 bg-white flex flex-col gap-4 items-center rounded-md shadow-lg">
            ...
            <Link
              href={"/"}
              className="bg-blue-500 text-white hover:bg-blue-700 hoverEffect px-8 py-3 rounded-lg font-semibold"
            >
              Continue Shopping
            </Link>
          </div>
